    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.talent-profiles.update", [$talentProfile->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('verification_status') ? 'is-invalid' : '' }}" name="verification_status" id="verification_status">
                    ...
                    @foreach(App\Models\TalentProfile::VERIFICATION_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('verification_status', $talentProfile->verification_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('verification_notes') ? 'is-invalid' : '' }}" type="text" name="verification_notes" id="verification_notes" value="{{ old('verification_notes', $talentProfile->verification_notes) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bio') ? 'is-invalid' : '' }}" type="text" name="bio" id="bio" value="{{ old('bio', $talentProfile->bio) }}">
                @if($errors->has('bio'))
                    <div class="invalid-feedback">
                        {{ $errors->first('bio') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" type="number" name="height" id="height" value="{{ old('height', $talentProfile->height) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="number" name="weight" id="weight" value="{{ old('weight', $talentProfile->weight) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('chest') ? 'is-invalid' : '' }}" type="number" name="chest" id="chest" value="{{ old('chest', $talentProfile->chest) }}" step="1">
                @if($errors->has('chest'))
                    <div class="invalid-feedback">
                        {{ $errors->first('chest') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('waist') ? 'is-invalid' : '' }}" type="number" name="waist" id="waist" value="{{ old('waist', $talentProfile->waist) }}" step="1">
                @if($errors->has('waist'))
                    <div class="invalid-feedback">
                        {{ $errors->first('waist') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hips') ? 'is-invalid' : '' }}" type="number" name="hips" id="hips" value="{{ old('hips', $talentProfile->hips) }}" step="1">
                @if($errors->has('hips'))
                    <div class="invalid-feedback">
                        {{ $errors->first('hips') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('skin_tone') ? 'is-invalid' : '' }}" name="skin_tone" id="skin_tone">
                    ...
                    @foreach(App\Models\TalentProfile::SKIN_TONE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('skin_tone', $talentProfile->skin_tone) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hair_color') ? 'is-invalid' : '' }}" type="text" name="hair_color" id="hair_color" value="{{ old('hair_color', $talentProfile->hair_color) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eye_color') ? 'is-invalid' : '' }}" type="text" name="eye_color" id="eye_color" value="{{ old('eye_color', $talentProfile->eye_color) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shoe_size') ? 'is-invalid' : '' }}" type="number" name="shoe_size" id="shoe_size" value="{{ old('shoe_size', $talentProfile->shoe_size) }}" step="1">
