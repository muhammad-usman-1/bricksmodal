...
<div class="dash-shell">
    <div class="page-header">
        <div>
            ...
            <h5 style="margin-top: 8px;">Rejected Talents</h5>
        </div>
    </div>

    <div class="panel">
        <div class="panel-head">
            <h6 class="panel-title">Manage Rejected Profiles</h6>
        </div>
            ...
            <div class="table-wrap">
                <table class="talent-table datatable">
                    ...
                    <tbody>
                        @forelse($talentProfiles as $talent)
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;">
                                    <form action="{{ route('admin.talent-profiles.reactivate', $talent) }}" method="POST" style="display:inline-block;" class="unreject-form">
                                        @csrf
                        ...
                        @empty
                            <tr>
                                <td colspan="5" style="text-align:center; padding:40px; color: var(--ink-500);">No rejected talents found</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
...
<script>
    $(function () {
        ...
        $('.unreject-form').on('submit', function(e) {
            e.preventDefault();
            const form = this;
            Swal.fire({
                title: 'Reactivate Talent?',
                text: "This talent will be moved back to pending status for review.",
                icon: 'question',
