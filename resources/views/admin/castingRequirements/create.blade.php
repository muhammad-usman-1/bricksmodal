...
@section('content')
    <div class="casting-wrap">
        <h2 class="casting-title">New Casting Request</h2>
                    ...
                    <div class="col">
                        ...
                        <div class="fgroup">
                            ...
                            <input class="form-control {{ $errors->has('project_name') ? 'is-invalid' : '' }}"
                                type="text" name="project_name" id="project_name" value="{{ old('project_name', '') }}"
                        ...
                        <div class="fgroup">
                            ...
                            <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender"
                                ...
                                @foreach (App\Models\CastingRequirement::GENDER_SELECT as $key => $label)
                                    <option value="{{ $key }}"
                                        {{ old('gender', 'any') === (string) $key ? 'selected' : '' }}>{{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="fgroup">
                            ...
                            <input class="form-control {{ $errors->has('hair_color') ? 'is-invalid' : '' }}" type="text"
                                name="hair_color" id="hair_color" value="{{ old('hair_color', '') }}"
                        ...
                        <div class="fgroup">
                            ...
                            <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes"
                                rows="4" placeholder="Add any additional notes">{{ old('notes') }}</textarea>
                            @if ($errors->has('notes'))
                    ...
                    <div class="col">
                        ...
                        <div class="fgroup">
                            ...
                            <div class="input-with-icon">
                                <input class="form-control {{ $errors->has('shoot_date_time') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('shoot_date_time') }}" placeholder="Select date and time">
                        ...
                        <div class="fgroup">
                            ...
                            <input class="form-control {{ $errors->has('age_range') ? 'is-invalid' : '' }}" type="text"
                                name="age_range" id="age_range" value="{{ old('age_range', '') }}"
                        ...
                        <div class="fgroup">
                            ...
                            <input class="form-control {{ $errors->has('count') ? 'is-invalid' : '' }}" type="number"
                                name="count" id="count" value="{{ old('count', '1') }}" step="1" required
                        ...
                        <div class="fgroup">
                            ...
                            <input class="form-control {{ $errors->has('rate_per_model') ? 'is-invalid' : '' }}"
                                ...
                                value="{{ old('rate_per_model', '') }}" step="0.01" required
                        ...
                        <div class="fgroup">
                            ...
                            <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status"
                                ...
                                @foreach (App\Models\CastingRequirement::STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}"
                                        {{ old('status', 'advertised') === (string) $key ? 'selected' : '' }}>
                                        {{ $label }}</option>
                                @endforeach
                            </select>
...
@section('scripts')
    ...
    <script>
        ...
        new Vue({
            el: '#outfit-selector',
            data: { selectedOutfits: {!! old('outfit', '{}') !!} }
        });
