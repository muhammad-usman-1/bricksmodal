...
<div class="settings-shell">
    <div class="settings-frame">
        <form method="POST" action="{{ route('talent.settings.update') }}">
            @csrf
            ...
            <div class="card-block">
                ...
                <div class="toggle-row">
                    <div class="toggle-text">
                        <span class="toggle-label">Shows Updates</span>
                        <span class="toggle-hint">Get notified about a show</span>
                    </div>
                    <label class="switch">
                        <input type="hidden" name="shows_updates" value="0">
                        <input type="checkbox" name="shows_updates" value="1" {{ $settings->shows_updates ? 'checked' : '' }}>
                        <span class="slider"></span>
                    </label>
                </div>
                <div class="toggle-row">
                    <div class="toggle-text">
                        <span class="toggle-label">Show Reminders</span>
                        <span class="toggle-hint">Reminders for upcoming shows</span>
                    </div>
                    <label class="switch">
                        <input type="hidden" name="show_reminders" value="0">
                        <input type="checkbox" name="show_reminders" value="1" {{ $settings->show_reminders ? 'checked' : '' }}>
                        <span class="slider"></span>
                    </label>
                </div>
                <div class="toggle-row">
                    ...
                    <div class="field">
                        ...
                        <div class="select-lite">
                            <select name="date_format">
                                <option value="">Choose your date format</option>
                                @foreach(['MM/DD/YYYY','DD/MM/YYYY','YYYY-MM-DD'] as $format)
                                    <option value="{{ $format }}" {{ $settings->date_format === $format ? 'selected' : '' }}>{{ $format }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="field">
                        ...
                        <div class="select-lite">
                            <select name="time_format">
                                <option value="">Choose your time format</option>
                                @foreach(['12-hour','24-hour'] as $format)
                                    <option value="{{ $format }}" {{ $settings->time_format === $format ? 'selected' : '' }}>{{ $format }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
