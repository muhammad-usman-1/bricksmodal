...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="card shadow-sm">
            <div class="card-header text-center font-weight-bold">{{ trans('global.talent_login') }}</div>

            <div class="card-body">
                <form method="POST" action="{{ route('talent.login.submit') }}">
                    @csrf
            ...
            <div class="card-footer text-center">
                <a href="{{ route('talent.register') }}">{{ trans('global.register') }}</a>
            </div>
        </div>
    </div>
</div>
