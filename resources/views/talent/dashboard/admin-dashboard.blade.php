<div class='col-span-1 lg:col-span-10 px-4 md:px-5' ref={tableRef}>
    ...
    <div class='grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 md:gap-5 mb-6'>
        <div class='border border-slate-300 shadow-md w-full p-2 sm:p-4 md:p-5 rounded-lg'>
            ...
            <p class='text-base sm:text-lg md:text-xl font-semibold'>200</p>
        </div>
        <div class='border border-slate-300 shadow-md w-full p-2 sm:p-4 md:p-5 rounded-lg'>
            <p class='pb-2 text-xs sm:text-sm md:text-base'>Pending Verification</p>
            <p class='text-base sm:text-lg md:text-xl font-semibold'>50</p>
        </div>
        <div class='border border-slate-300 shadow-md w-full p-2 sm:p-4 md:p-5 rounded-lg'>
            <p class='pb-2 text-xs sm:text-sm md:text-base'>Recent Sign-ups</p>
            <p class='text-base sm:text-lg md:text-xl font-semibold'>20</p>
        </div>
        <div class='border border-slate-300 shadow-md w-full p-2 sm:p-4 md:p-5 rounded-lg'>
            <p class='pb-2 text-xs sm:text-sm md:text-base'>Active Campaigns</p>
            <p class='text-base sm:text-lg md:text-xl font-semibold'>5</p>
        </div>
        <div class='border border-slate-300 shadow-md w-full p-2 sm:p-4 md:p-5 rounded-lg'>
    ...
    <div class="overflow-x-auto">
        <table class='border border-slate-300 border-separate overflow-hidden rounded-lg w-full min-w-[800px]'>
            ...
            <tbody class='border-b border-slate-300 text-left'>
                <tr>
                    <td class='p-2 md:p-3'><img src="/images/model1.jpg" alt="Model" class='w-10 h-10 md:w-12 md:h-12 object-cover rounded-full' /></td>
                    ...
                    <td class='p-2 md:p-3 text-sm md:text-base'>Female</td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>5'6"</td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>130 lbs</td>
                    <td class='p-2 md:p-3'>
                        <span class='bg-green-100 px-2 py-1 rounded-full text-xs md:text-sm flex justify-center items-center w-16 md:w-20'>Verified</span>
                    </td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>2023-01-15</td>
            ...
            <tbody class='border-b border-slate-300 text-left'>
                <tr>
                    <td class='p-2 md:p-3'><img src="/images/model.jpg" alt="Model" class='w-10 h-10 md:w-12 md:h-12 object-cover rounded-full' /></td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>
                        <div class="flex items-center gap-2">
                            John Smith
                        </div>
                    </td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>Male</td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>5'8"</td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>150 lbs</td>
                    <td class='p-2 md:p-3'>
                        <span class='bg-yellow-100 px-2 py-1 rounded-full text-xs md:text-sm flex justify-center w-16 md:w-20'>Suspend</span>
                    </td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>2023-01-15</td>
                    <td class="p-2 md:p-3 relative text-center">
                        <details class="inline-block">
                            ...
                            <div
                                class="absolute bottom-8 right-20  w-36 bg-white border rounded shadow z-20 mt-2">
                                <button class="w-full text-left px-3 py-2 hover:bg-gray-100">View</button>
                                <button
                                    class="w-full text-left px-3 py-2 hover:bg-gray-100">Approved</button>
                                <button
                                    class="w-full text-left px-3 py-2 hover:bg-gray-100">Rejected</button>
                                <button
                                    class="w-full text-left px-3 py-2 hover:bg-gray-100 text-red-600">Delete</button>
                            </div>
                        </details>
            ...
            <tbody class='border-b border-slate-300 text-left'>
                <tr>
                    <td class='p-2 md:p-3'><img src="/images/model.jpg" alt="Model" class='w-10 h-10 md:w-12 md:h-12 object-cover rounded-full' /></td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>John Smith</td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>Male</td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>5'8"</td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>150 lbs</td>
                    <td class='p-2 md:p-3'>
                        <span class='bg-stone-100 px-2 py-1 rounded-full text-xs md:text-sm flex justify-center w-16 md:w-20'>Pending</span>
                    </td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>2023-01-15</td>
                    <td class="p-2 md:p-3 relative text-center">
                        <details class="inline-block">
            ...
            <tbody class='border-b border-slate-300 text-left'>
                <tr>
                    ...
                    <td class='p-2 md:p-3 text-sm md:text-base'>150 lbs</td>
                    <td class='p-2 md:p-3'>
                        <span class='bg-green-100 px-2 py-1 rounded-full text-xs md:text-sm flex justify-center w-16 md:w-20'>Verified</span>
                    </td>
                    <td class='p-2 md:p-3 text-sm md:text-base'>2023-01-15</td>
                    <td class="p-2 md:p-3 relative text-center">
                        <details class="inline-block">
